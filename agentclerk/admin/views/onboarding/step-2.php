...
<div class="wrap ac-wrap">
    <div class="ac-steps">
        ...
        <div class="ac-step current"><div class="ac-step-num">2</div><span>Scan site</span></div><div class="ac-step-line"></div>
    ...
    <div class="ac-explain-box" id="scan-intro">
        ...
        <div class="ac-explain-step"><div class="ac-explain-step-num">1</div><div><strong>Sitemap crawl</strong> &mdash; every page your site publishes is queued.</div></div>
        <div class="ac-explain-step"><div class="ac-explain-step-num">2</div><div><strong>Content extraction</strong> &mdash; products, prices, policies, FAQs, and support content are pulled and structured.</div></div>
        <div class="ac-explain-step"><div class="ac-explain-step-num">3</div><div><strong>Knowledge draft</strong> &mdash; your seller agent's initial knowledge base is built from what we found.</div></div>
        <div class="ac-explain-step" style="margin-bottom:14px"><div class="ac-explain-step-num">4</div><div><strong>Gap report</strong> &mdash; anything we couldn't find is flagged so you can fill it in on the next screen.</div></div>
        <div class="ac-flex">
            <button class="ac-btn ac-btn-electric ac-btn-lg" id="start-scan">Scan my site and start setup &rarr;</button>
    ...
    <div id="scan-running" style="display:none">
        <div class="ac-grid-2">
            <div>
                <div class="ac-card">
                    <div class="ac-card-head"><h2>Scan progress</h2><span class="ac-badge ac-badge-amber" id="scan-badge"><span class="ac-spinner"></span>Scanning&hellip;</span></div>
                    <div class="ac-card-body">
                        <div class="ac-scan-log" id="scan-log">
                            <div class="ac-scan-heading">preparing</div>
                            <div><span class="ac-spinner"></span><span class="ac-scan-dim">Starting scan&hellip;</span></div>
                        </div>
            ...
            <div>
                <div class="ac-card">
                    ...
                    <div class="ac-card-body" id="scan-findings">
                        <div class="ac-callout ac-callout-slate"><span class="ac-callout-icon">&#8987;</span><span>Waiting for scan results&hellip;</span></div>
                    </div>
                </div>
                <div class="ac-callout ac-callout-slate"><span class="ac-callout-icon">&#8505;</span><span>The chat to fill in any gaps will appear on the next screen once scanning finishes.</span></div>
            </div>
        </div>
    </div>

    <div id="scan-done" style="display:none;margin-top:8px">
        <button class="ac-btn ac-btn-electric ac-btn-lg" id="scan-continue">Scan complete &mdash; review results &rarr;</button>
    </div>
</div>
...
jQuery(function($) {
    ...
    function updateFindings(d) {
        var html = '';
        if (d.products_found) html += '<div class="ac-callout ac-callout-green"><span class="ac-callout-icon">&#10003;</span><span><strong>' + d.products_found + ' products</strong> with names, prices, and descriptions.</span></div>';
        if (d.refund_found) html += '<div class="ac-callout ac-callout-green"><span class="ac-callout-icon">&#10003;</span><span><strong>Refund policy</strong> found.</span></div>';
        if (d.license_found) html += '<div class="ac-callout ac-callout-green"><span class="ac-callout-icon">&#10003;</span><span><strong>License terms</strong> found.</span></div>';
        if (d.blog_found) html += '<div class="ac-callout ac-callout-green"><span class="ac-callout-icon">&#10003;</span><span><strong>Blog content</strong> found.</span></div>';
        if (d.gaps) {
