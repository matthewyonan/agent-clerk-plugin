...
<div class="wrap ac-wrap">
    <div class="ac-steps">
        ...
        <div class="ac-step done"><div class="ac-step-num">&#10003;</div><span>Placement</span></div><div class="ac-step-line"></div>
        <div class="ac-step current"><div class="ac-step-num">6</div><span>Go live</span></div>
    </div>

    <div class="ac-page-title">Test your agent before going live</div>
    <div class="ac-page-subtitle">Try it as a buyer would. No transaction is processed in test mode.</div>
        ...
        <div>
            <div class="ac-chat-shell" style="height:400px">
                <div class="ac-chat-header">
                    ...
                    <div>
                        <div class="ac-chat-name">AgentClerk <span style="font-size:10px;background:rgba(245,158,11,0.2);color:var(--ac-amber);padding:1px 6px;border-radius:3px;font-family:'DM Mono',monospace">TEST</span></div>
                        <div class="ac-chat-status">&#9679; Ready</div>
                    </div>
                </div>
                <div class="ac-messages" id="test-messages" style="height:280px;max-height:280px"></div>
                <div class="ac-chat-input-row">
                    <input type="text" class="ac-chat-input" id="test-input" placeholder="Ask as a buyer would&hellip;">
        ...
        <div>
            <div class="ac-card ac-mb">
                ...
                <div class="ac-card-body">
                    <div class="ac-score-row">
                        <div class="ac-score-label">Business context</div>
                        <div class="ac-score-track"><div class="ac-score-fill" style="width:<?php echo $business_score; ?>%;background:<?php echo ac_score_color( $business_score ); ?>"></div></div>
                        <div class="ac-score-value" style="color:<?php echo ac_score_color( $business_score ); ?>"><?php echo $business_score; ?>%</div>
                    </div>
                    <div class="ac-score-row">
                        <div class="ac-score-label">Catalog</div>
                        <div class="ac-score-track"><div class="ac-score-fill" style="width:<?php echo $catalog_score; ?>%;background:<?php echo ac_score_color( $catalog_score ); ?>"></div></div>
                        <div class="ac-score-value" style="color:<?php echo ac_score_color( $catalog_score ); ?>"><?php echo $catalog_score; ?>%</div>
                    </div>
                    <div class="ac-score-row">
                        <div class="ac-score-label">Policies</div>
                        <div class="ac-score-track"><div class="ac-score-fill" style="width:<?php echo $policy_score; ?>%;background:<?php echo ac_score_color( $policy_score ); ?>"></div></div>
                        <div class="ac-score-value" style="color:<?php echo ac_score_color( $policy_score ); ?>"><?php echo $policy_score; ?>%</div>
                    </div>
                    <div class="ac-score-row">
                        <div class="ac-score-label">Support file</div>
                        <div class="ac-score-track"><div class="ac-score-fill" style="width:<?php echo $support_score; ?>%;background:<?php echo ac_score_color( $support_score ); ?>"></div></div>
                        <div class="ac-score-value" style="color:<?php echo ac_score_color( $support_score ); ?>"><?php echo $support_score; ?>%</div>
                    </div>
                    <?php if ( $support_score < 75 ) : ?>
                        <hr>
                        <div class="ac-callout ac-callout-amber" style="margin-bottom:0"><span class="ac-callout-icon">&#9888;</span><span>Support file is a draft. Improve it any time in Settings &rarr; Support &amp; Escalation.</span></div>
                    <?php endif; ?>
                </div>
            </div>
            ...
            <div class="ac-card">
                <div class="ac-card-body" style="text-align:center;padding:20px 17px">
                    ...
                    <button class="ac-btn ac-btn-electric ac-btn-lg" id="go-live" style="width:100%">Go live &rarr;</button>
...
jQuery(function($) {
    function addMsg(role, text) {
        ...
        $('#test-messages').append('<div class="ac-msg ' + cls + '"><div class="ac-msg-avatar">' + av + '</div><div class="ac-msg-bubble">' + text + '</div></div>');
