...
$agentclerk_is_lifetime = ( 'active' === $agentclerk_license );
$agentclerk_fee_rate = ( $agentclerk_tier === 'turnkey' ) ? '1.5% or $1.99 min' : '1% or $1.00 min';
?>
<div class="wrap ac-wrap">
    ...
    <div class="ac-g2">
        ...
        <div class="ac-card"><div class="ac-card-head"><h2><?php echo esc_html( 'What gets charged' ); ?></h2></div><div class="ac-card-body">
            <div class="ac-tog-row"><div><div class="ac-tog-lbl"><?php echo esc_html( 'Sales via agent' ); ?></div><div class="ac-tog-desc"><?php echo esc_html( 'When agent generates a quote and buyer completes checkout' ); ?></div></div><span style="font-family:'DM Mono',monospace;font-size:11px;font-weight:500;color:var(--elec-dk)"><?php echo esc_html( $agentclerk_fee_rate ); ?></span></div>
